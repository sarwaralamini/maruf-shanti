...
{{-- Facebook SEO --}}
@section('og_title', 'Healthy Living')
            ...
            <div class="mad-section">
                ...
                <article class="mad-entity">
                    <div style="max-width:100rem;font-size: 1.125rem;line-height:1.5rem;" >
                        <div class="mad-entity-pre-title">Healthy Living</div>
                        ...
                        <p style="text-align:justify;">
                            Indulge your senses. Here at Shanti, you can also order sumptuous, healthy food to enjoy with your loved ones.
                        </p>
                        ...
                        <p>
                            <img src="{{ asset('assets/img/healthy-living.jpg') }}" alt="" />
                        </p>
                    </div>
                </article>
                <!--================ End of Entity ================-->
