    ...
    <div class="container">
      ...
      <div class="
        ...
        <div class="mad-icon-boxes grid-type hr-type item-col-4 no-gutters">
          <!--================ Icon Box ================-->
          <a href="{{ route('book.now') }}" target="_blank" class="mad-icon-box">
          ...
          <!--================ End of Icon Box ================-->
          <!--================ Icon Box ================-->
          <a href="{{ route('book.now') }}" target="_blank" class="mad-icon-box" data-bg-image-src="{{ asset('assets/img/home_section_2/01.jpg') }}">
          ...
          <!--================ End of Icon Box ================-->
          <!--================ Icon Box ================-->
          <a href="{{ route('book.now')}}" target="_blank" class="mad-icon-box" data-bg-image-src="{{ asset('assets/img/home_section_2/02.jpg') }}">
        ...
        <div class="
          ...
          <!--================ End of Icon Box ================-->
          <!--================ Icon Box ================-->
          <a href="{{ route('book.now')}}" target="_blank" class="mad-icon-box" data-bg-image-src="{{ asset('assets/img/home_section_2/04.jpg') }}">
          ...
          <!--================ End of Icon Box ================-->
          <!--================ Icon Box ================-->
          <a href="{{ route('book.now')}}" target="_blank" class="mad-icon-box" data-bg-image-src="{{ asset('assets/img/home_section_2/03.jpg') }}">
      ...
      <div class="
        ...
        <div class="content-element-main">
          ...
          <div class="mad-icon-boxes grid-type hr-type item-col-4 no-gutters">
            ...
            <!--================ End of Icon Box ================-->
            <!--================ Icon Box ================-->
            <a href="{{ route('book.now')}}" target="_blank" class="mad-icon-box empty-item" data-bg-image-src="{{ asset('assets/img/home_section_2/05.jpg') }}">
            ...
            <!--================ End of Icon Box ================-->
            <!--================ Icon Box ================-->
            <a href="{{ route('book.now')}}" target="_blank" class="mad-icon-box" data-bg-image-src="{{ asset('assets/img/home_section_2/06.jpg') }}">
